			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						</svg><span class="side-menu__label">الرئيسيه</a>
					</li>
					@can('الفواتير')
					<li class="side-item side-item-category">الفواتير</li>
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='invoices') }}">
						...
						@can('الفواتير المدفوعة')
							...
							<li><a class="slide-item" href="{{ url('/' . $page='invoices_Partial') }}">الفواتير المدفوعهاجزئيا</a></li>
							@endcan
							@can('الفواتير الغير المدفوعة جزئيا')
						...
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
							...
							viewBox="0 0 24 24" ><g><rect fill="none"/></g><g><g/><g>
							 ...
							 opacity=".3"/></g><g>
								...
								<path d="M17.5,13.16c0.88,0,1.73,0.09,2.5,0.26V11.9c-0.79-0.15-1.64-0.24-2.5-0.24c-1.28,0-2.46,0.16-3.5,0.47v1.57 C14.99,13.36,16.18,13.16,17.5,13.16z"/><path d="M17.5,15.83c0.88,0,1.73,0.09,2.5,0.26v-1.52c-0.79-0.15-1.64-0.24-2.5-0.24c-1.28,0-2.46,0.16-3.5,0.47v1.57 C14.99,16.02,16.18,15.83,17.5,15.83z"/></g></g></svg>
